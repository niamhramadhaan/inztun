...
export class FlipText {
  ...
  init(root) {
    this.inputEl = root.querySelector('#ft-input');
    this.outputEl = root.querySelector('#ft-output');
    this.countEl = root.querySelector('#ft-input-count');

    root.querySelector('#ft-flip')?.addEventListener('click', () => this.flip());
    root.querySelector('#ft-copy')?.addEventListener('click', () => {
