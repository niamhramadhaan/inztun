...
const ALL_TOOLS: Record<string, { Tool: ToolClass; module: string; name: string; description: string }> = {
  ...
  'ascii-art': { Tool: AsciiArt, module: 'playground', name: 'ASCII Art', description: 'Generate ASCII art text banners.' },
  'morse-code': { Tool: MorseCode, module: 'playground', name: 'Morse Code', description: 'Encode and decode Morse code with audio playback.' },
