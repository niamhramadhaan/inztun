...
export class UrlEncoder {
  ...
  init(root) {
    this.inputEl = root.querySelector('#ue-input');
    this.outputEl = root.querySelector('#ue-output');
    this.partsEl = root.querySelector('#ue-parts');
    this.countEl = root.querySelector('#ue-input-count');
