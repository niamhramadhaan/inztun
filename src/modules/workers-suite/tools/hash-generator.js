...
export class HashGenerator {
  ...
  init(root) {
    this.inputEl = root.querySelector('#hg-input');
    this.sha256El = root.querySelector('#hg-sha256');
    this.sha1El = root.querySelector('#hg-sha1');
    this.md5El = root.querySelector('#hg-md5');
    this.countEl = root.querySelector('#hg-input-count');
    ...
    root.querySelectorAll('[data-hash]').forEach(btn => {
