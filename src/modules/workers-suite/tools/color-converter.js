...
export class ColorConverter {
  constructor() {
    this.id = 'color-converter';
    this.name = 'Color Converter';
  ...
  init(root) {
    this.hexInput = root.querySelector('#cc-hex');
    this.picker = root.querySelector('#cc-picker');
    this.preview = root.querySelector('#cc-preview');
    this.rgbDisplay = root.querySelector('#cc-rgb');
    this.hslDisplay = root.querySelector('#cc-hsl');
